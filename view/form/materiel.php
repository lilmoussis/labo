<?php include '../../backend/configuration/conf.php'; ?>
<!DOCTYPE html>
<html lang="en">
...
<div class="page-flex">
    ...
    <div class="main-wrapper">
        ...
        <div style="width: 100px;margin-top:2rem" ><a href="http://localhost/labo/view/layout/materiel_layout.php">
    ...
    <article class="sign-up" style="margin-bottom: 250px;">
        ...
        <form class="sign-up-form form" action="materiel.php" method="post">
            <div class="d-flex">
                <label class="form-label-wrapper w-45" style="margin-right: 15px;"> 
                    <p class="form-label">Nom du materiel</p>
                    <input class="form-input" type="text" placeholder="Entrer le nom du materiel" name="nom" required>
                </label> 
                <label class="form-label-wrapper w-45" style="margin-right: 15px;"> 
                    <p class="form-label">Quantite</p>
                    <input class="form-input" type="number" placeholder="Entrer le nom du materiel" name="quantite" required>
                </label> 
                </div>
            <div class="d-flex">
...
if (isset($_POST['nom'])&&isset($_POST['quantite'])&&isset($_POST['poids'])&&isset($_POST['description'])){
    ...
    $sql = "INSERT INTO `materiel` ( `nom_materiel`, `quantite_materiel`, `poids_materiel`, `description_materiel`) VALUES (:nom,:quantite,:poids,:description);";
...
} header('location : ../../../../../view/layout/materiel_layout.php');
}
?>